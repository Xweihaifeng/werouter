                ...
                if (result.code === 200) {
                    ...
                    $.each(result.data.list, function(key, val) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td class="text-center"><a title = "编辑" class="btn btn-info" style="margin-right:10px;"  href="roles_edit.html?weid=' + val.weid + '">编辑</a><a title = "删除" class="btn btn-danger" data-toggle="modal" data-target="#myModal" data-id="' + val.weid + '" data-name="' + val.name + '"  href="#">删除</a></td></tr>';
                    });
