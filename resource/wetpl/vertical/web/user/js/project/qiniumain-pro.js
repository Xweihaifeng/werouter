...
$(function() {
  var imglength=0;
  var imgexitlen=$(".progressContainer").length;
  console.log(imgexitlen);
  var totallen=0;
  var uploader = Qiniu.uploader({
    disable_statistics_report: false,
    runtimes: 'html5,flash,html4',
    browse_button: 'pickfiles-more',
    container: 'container',
    ...
    init: {
      ...
      'FilesAdded': function(up, files) {
        ...
        console.log($("#fsUploadProgress ").children());
        console.log($(".progressContainer").length);
        imgexitlen=$(".progressContainer").length;
        if($(".progressContainer").length<5){
          plupload.each(files, function(file) {
            imglength=files.length;
            totallen=imgexitlen+imglength;
            if(files.length<5 && imgexitlen<5 && totallen<5){
      ...
      'BeforeUpload': function(up, file) {
        ...
        if(imglength<5 && imgexitlen<5 && totallen<5){
      ...
      'FileUploaded': function(up, file, info) {
        if(imglength<5 && imgexitlen<5 && totallen<5){
          ...
          $(".progressCancel").bind("click",function(){
            // console.log($(this).closest(".progressContainer"));
