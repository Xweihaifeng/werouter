        ...
        success: function(data){
            if(data.code == 200) {
                ...
                if(!result.thumb_image) {
                    $(".zuzhi-top").css({ "background-image": "url("+ApiMaterPlatQiniuDomain+"'plat/cert/1505289973450.png')","background-size": "100% 100%","background-repeat": "no-repeat","background-position": "center" });
                ...
                if(!result.back_image) {
                    $("#org_bottom_big_img").css({ "background-image": "url("+ApiMaterPlatQiniuDomain+"'plat/cert/1505289973450.png')" });
