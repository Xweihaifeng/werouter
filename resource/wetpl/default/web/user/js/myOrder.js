        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data.code == 200) {
                    ...
                    listdata.map(x => {
                        // $(".ordertable tbody").append(orderlisthtml(x));
...
// var selectorder=function(){
    $(".btn-select").bind("click",function(){
        ...
        orderlist(weid,1,statusid,{time_start:time_start,time_end:time_end,order_num:order_num});
    })
// }
    ...
    var orderlisthtml=function(data){
        if(data.status>1){
            if(data.logistics_status==1){
               ...
               sendgoods= status_pay;
                ...
                status_pay="已发货";
                // sendgoods="";
                // sendgoods='<button type="button" class="btn btn-success btn-message" data-toggle="modal" data-id="" data-target=".bs-example-modal-sm" style="margin-right:15px;">评论</button>';
            ...
            status_pay="未支付";
            // sendgoods='<button type="button" class="btn btn-success btn-pay" data-toggle="modal" data-id="486" data-target=".bs-example-modal-sm" style="margin-right:15px;">付款</button><button type="button" class="btn btn-danger btn-order-del">删除</button>';
        ...
        /*var listhtml='<tr id="'+data.weid+'">'+
                ...
                '<td class="btn-sendgoods" data-id="'+data.goods_id+'">'+sendgoods+'</td>'+
            '</tr>';*/
...
var malldetail=function(x,mall_id){
 ...
 // 获取订单详情
    ...
    var delorder=function(obj){
        // $(".btn-order-del").bind("click",function(){
            var orderid=$(obj).closest("tr").attr("id");
            console.log(orderid);
            $.ajax({
