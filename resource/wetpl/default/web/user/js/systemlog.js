 ...
 */
//列表折叠
sessionStorage.listname='we-log';
...
*/
            ...
            success: function(data){
                ...
                if (data.data != null) {
                    ...
                    $("#buyNow").click(function(){
                        ...
                        //qrWindow(weid, apiUrl+'user/admin/app/' + weid);
                    })
    ...
    var init = function(id){
        $.ajax({
            url: apiUrl+'sms/usersms/detaibyuserid/' + id,
            type: 'GET',
            success: function(data){
                console.log(data);
                // moduleState();
    ...
    var qrcodeBuy = function(id, password, count){
        $.ajax({
            url: apiUrl+'wechatpay/smspay?id=' + id + '&secret=' + password,
            type: 'GET',
            success: function(data){
                console.log(data);
                //轮询订单接口的weid
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                var check = setInterval(function(){
                    $.ajax({
                        url: apiUrl+'sms/order/detail/' + id,
                        type: 'GET',
                        success: function(data) {
                            console.log(data);
