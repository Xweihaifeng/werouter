...
// $(function () {
//     template.helper("myT", function (e, e2) {
//
//         alert($(".123"+e2));
...
//         var intDiff = parseInt((24 * 60 * 60) - (data - date2) / (1000));    //倒计时总秒数量
...
//                 //$('#day_show').html(day );
//                 console.log(pr.find('.hour_show').html());
//                 pr.find('.hour_show').html('<s id="h">44444</s>' + hour);
