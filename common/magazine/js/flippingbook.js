function FlippingBook() {
	...
	this.settings = {
			...
			//backgroundImage: "/common/magazine/img/bookBackground.jpg",
			backgroundImagePlacement: "fit", //  "top left", "center", "fit"
			printEnabled: true,
			printTitle: "打印页面",
			downloadURL: "",
			downloadTitle: "下载PDF",
			downloadSize: "大小: 4.7 MB",
...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("/common/magazine/FlippingBook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "/common/magazine/js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#" + this.settings.backgroundColor.toString( 16 ) });
}
